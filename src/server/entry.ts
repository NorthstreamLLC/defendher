...
// <api-imports>
import auth_login_post_0 from "./api/auth/login/POST";
import auth_logout_post_1 from "./api/auth/logout/POST";
import auth_register_post_2 from "./api/auth/register/POST";
import customers_me_get_3 from "./api/customers/me/GET";
import customers_me_put_4 from "./api/customers/me/PUT";
import health_get_5 from "./api/health/GET";
import orders_get_6 from "./api/orders/GET";
import orders_post_7 from "./api/orders/POST";
import orders_id_get_8 from "./api/orders/[id]/GET";
// </api-imports>
...
// <api-registrations>
app.post("/api/auth/login", auth_login_post_0);
app.post("/api/auth/logout", auth_logout_post_1);
app.post("/api/auth/register", auth_register_post_2);
app.get("/api/customers/me", customers_me_get_3);
app.put("/api/customers/me", customers_me_put_4);
app.get("/api/health", health_get_5);
app.get("/api/orders", orders_get_6);
app.post("/api/orders", orders_post_7);
app.get("/api/orders/:id", orders_id_get_8);
// </api-registrations>
